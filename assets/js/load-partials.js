...
async function loadAllSections() {
    await loadSection('header-container', 'partials/header.html');
    await loadSection('hero-container', 'partials/hero.html');
    await loadSection('about-container', 'partials/about.html');
